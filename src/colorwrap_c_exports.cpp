...
int* colorwrapMemAlloc( int num_colors )
{
    void *memptr = (void *) malloc(3 * num_colors * sizeof(int));
...
void colorwrapMemFree( int rgb_colormap[] )
{
    if ( rgb_colormap != (int *) NULL )
    {
        free(rgb_colormap);
    }

    rgb_colormap = (int *) NULL;
}
